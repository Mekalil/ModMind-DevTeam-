...
public class main extends Mod{
    ...
    public static Block tankFactoty, mechFactory, aircraftFactory, heatRefabricator, shieldRefabricator, supportRefabricator, quatumnAssembler, atomicAssembler, shipAssembler, AtierModule, StierModule, unitRepairTower;
    public static Block cophalastPayload, cophalastPayloadRouter, xenathiumPayloadDriver, xenathiumConstructor;
    ...
    public void loadContent(){
        ...
        // unit category: Comming soon!
        // end of unit, next one item:
        ...
        // end of walls, next one unit factory 
        
        tankFactoty = new UnitFactory("Tank-factory"){{
